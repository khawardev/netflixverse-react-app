# Netflix verse React app

NetflixVerse is a dynamic and immersive web application built using React.js and Redux Toolkit. This app allows users to explore a vast collection of movies and TV shows, featuring a responsive user interface and seamless navigation. With features like dynamic background images, search functionality, detailed title pages with trailers and cast information, as well as recommended/similar content, NetflixVerse offers an enhanced viewing experience. The app showcases the power of React.js and demonstrates the developer's proficiency in building engaging entertainment platforms.
...
Check out the live demo of the Netflix verse React app [here](netflix-verse.vercel.app/).

## Screenshots

![App Screenshot](https://res.cloudinary.com/denajbnh4/image/upload/v1688564026/Khawar/Screenshot_2_icwhqs.png)
